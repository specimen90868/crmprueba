 ...
 */
 ...
 if($_pagi_conteo_alternativo == false){
 	...
 	$_pagi_result2 = mysql_query($_pagi_sqlConta,$dbanabiosis);
	...
	$_pagi_result3 = mysql_query($_pagi_sql,$dbanabiosis);
	// Si ocurrió error y mostrar errores está activado
 ...
 */
 ...
 $_pagi_result = mysql_query($_pagi_sqlLim,$dbanabiosis);
 // Si ocurrió error y mostrar errores está activado
 ...
 */
 ...
 $_pagi_info = " $_pagi_desde al $_pagi_hasta de $_pagi_totalReg";
