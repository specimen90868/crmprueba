  ...
  <div id="contentblank">
    <div id="content">
      <div id="contentmid">
        ...
        <?php		
		$filtro="";
		$sqletapa = "call proceso_abierto('".$_POST[promotor]."');";
		...
		{ 
			$strXML.= "<set label='".$rwetapa[Etapa]."' value='".$rwetapa[Total]."'  />";
		}
		$strXML.="</chart>";
		...
		$ruta = "Data/";
		if($_POST[promotor]){$name_file = $promotor."_etapas.xml";}else{$name_file = "todos_etapas.xml";}
