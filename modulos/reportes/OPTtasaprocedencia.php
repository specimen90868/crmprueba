...
<div id="headerbg">
  ...
  <div id="titulo">Tasa de Conversión por Procedencia</div>
  ...
  <div id="contentblank">
    <div id="content">
      <div id="contentmid">
        ...
        <div id="resultadoorg">
        <fieldset class="fieldsetgde">
        <legend>Tasa de Conversión por Procedencia</legend>
        ...
        <?php		
		$filtro="";
		$sqlprocedencia = "call indice_conversion_procedencia('".$_POST[promotor]."','".$_POST[date_ini]."','".$_POST[date_fin]."');";
		//echo $sqlprocedencia;
		$rsprocedencia = mysql_query($sqlprocedencia,$db);	
		$strXML = "<chart caption='' xAxisName='Medio de Procedencia' yAxisName='Organizaciones' numberPrefix='' showValues='1' bgColor='FFFFFF' borderColor='E3E3E3' palette='3' borderThickness='1' showShadow='0' borderAlpha='100' plotGradientColor='' showPercentValues='1'>";
		while($rwprocedencia = mysql_fetch_array($rsprocedencia))
		{ 
			$strXML.= "<set label='".$rwprocedencia[Procedencia]."' value='".$rwprocedencia[Conversion]."'  />";
		}
		$strXML.="</chart>";
		...
		$ruta = "Data/";
		if($_POST[promotor]){$name_file = $promotor."_tasaprocedencia.xml";}else{$name_file = "todos_tasaprocedencia.xml";}
        ...
        var myChart = new FusionCharts( 'Column2D', 'myChartId', '930', '300' );
